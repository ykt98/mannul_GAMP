...
for i=1:m - NCOVER
    ...
    if success ==1;
        ...
        std_n = std(ENU(i:m,2));
        rms_n = rms(ENU(i:m,2));
        std_n0 = std(ENU(1:i-1,2));
        rms_n0 = rms(ENU(i:m,2));
        break;
    end;
end;
if i == m - NCOVER
...
fprintf(fid,'  %10.2f',std_e*100);
fprintf(fid,'  %10.3f',std_n*100);
% fprintf(fid,'  %10.3f %s',rms_u*100,'(cm)');
fprintf(fid,'  %10.3f',std_u*100);
